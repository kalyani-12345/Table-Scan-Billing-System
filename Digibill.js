document.addEventListener("DOMContentLoaded", function () 
{
    ...
    // Update total price
    document.querySelector(".bill-total p").innerHTML = `<strong>Total Price:</strong> ₹${totalPrice}`;
  const { jsPDF } = window.jspdf;
  
  // ✅ FIXED: Proper PDF Download Function
  ...
  // ✅ FIXED: SMS Sending with API (Twilio or another SMS Gateway)
  document.getElementById("send-sms").addEventListener("click", function () {
    ...
    fetch("https://your-sms-api.com/send", {  // Change this to your SMS API
      method: "POST",
